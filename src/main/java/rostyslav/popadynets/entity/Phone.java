...
@Builder
@Entity
@Table(name = "phone", indexes = @Index(columnList = "manufacturer, price"))
public class Phone extends BaseEntity {
	...
	@Column(columnDefinition = "DECIMAL(3,1)", name = "display_diagonal", nullable = false)
	...
	@Column(name = "number_sim", nullable = false)
